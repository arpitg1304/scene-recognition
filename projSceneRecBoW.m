...
if strcmp(FEATURE,'tiny image')
    dist_met = 'euclidean'
    %dist_met = 'cosine'
end
if strcmp(FEATURE,'bag of words')
    dist_met = 'spearman'
end
...
switch lower(FEATURE)    
    ...
    case 'bag of words'
        ...
        train_image_feats = get_bags_of_words(train_image_paths, 'train');
        % Possibly write out train_image_features here as a *.mat
        test_image_feats  = get_bags_of_words(test_image_paths, 'split');
...
switch lower(CLASSIFIER)    
    case 'nearest neighbor'
        ...
        predicted_categories = nearest_neighbor_classify(train_image_feats, train_labels, test_image_feats, dist_met);
